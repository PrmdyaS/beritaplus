...
public class NewsHistoryAdapter extends RecyclerView.Adapter<NewsHistoryAdapter.NewsViewHolder> {
    ...
    public NewsHistoryAdapter(List<Article> articles) {
    ...
    public NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_news_search, parent, false);
